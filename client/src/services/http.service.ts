...
//     headers = headers.set('Content-Type', 'application/json');
//     headers = headers.set('Authorization', `Bearer ${authToken}`);
//     return this.http.post(this.serverName + '/api/doctor/appointments/complete?appointmentId=' + appointmentId, {}, { headers: headers });
//   }
...
getAllDoctors(): Observable<any> {
    ...
    headers = headers.set('Content-Type', 'application/json');
    headers = headers.set('Authorization', `Bearer ${authToken}`);
    return this.http.get(this.serverName + `/api/doctors`, { headers: headers });
  }
  ...
  getAllPatients(): Observable<any> {
    ...
    headers = headers.set('Content-Type', 'application/json');
    headers = headers.set('Authorization', `Bearer ${authToken}`);
    return this.http.get(this.serverName + `/api/patients`, { headers: headers });
  }
...
deleteAppointment(appointmentId: any): Observable<any> {
    ...
    headers = headers.set('Content-Type', 'application/json');
    headers = headers.set('Authorization', `Bearer ${authToken}`);
    return this.http.delete(this.serverName + `/api/appointment/`+appointmentId, { headers: headers });
  }
