...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/doctors").hasAuthority("RECEPTIONIST")
                .antMatchers(HttpMethod.GET, "/api/patients").hasAuthority("RECEPTIONIST")
                ...
                .antMatchers(HttpMethod.DELETE, "/api/appointment/{appointmentId}").hasAuthority("RECEPTIONIST")
